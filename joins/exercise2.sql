...
SELECT bks.start_time as start, fcs.name FROM cd.facilities fcs
JOIN cd.bookings bks ON bks.facility_id = fcs.facility_id 
WHERE fcs.name LIKE '%Tennis Court%' AND 
bks.start_time >= '2012-09-21' AND 
